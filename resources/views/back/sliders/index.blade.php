                                        ...
                                        <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                                            <thead class="bg-slate-200 dark:bg-slate-700">
                                                <tr>
                                                    ...
                                                    <th scope="col" class="table-th">Getting</th>
                                                    <th scope="col" class="table-th">Title</th>
                                                    <th scope="col" class="table-th">Image</th>
                                                    <th scope="col" class="table-th">Subtitle</th>
                                                    <th scope="col" class="table-th">Project</th>
                                                    <th scope="col" class="table-th">experience</th>
                                            ...
                                            <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                                ...
                                                <tr class="even:bg-slate-50 dark:even:bg-slate-700">
                                                    ...
                                                    <td class="table-td">{{ $slider->getting }}</td>
                                                    <td class="table-td">{{ $slider->title }}</td>
                                                    <td class="table-td">
                                                        <img class=" w-20" src="{{ asset($slider->image) }}" alt="image">
                                                    </td>
                                                    <td class="table-td">{{ $slider->subtitle }}</td>
                                                    <td class="table-td">{{ $slider->project }}</td>
                                                    <td class="table-td">{{ $slider->experience }}</td>
                                                    <td class="table-td">{{ $slider->description }}</td>
                                                    <td class="table-td">{{ $slider->created_at->format("d M Y") }}</td>
                                                        ...
                                                        <td class="table-td">
                                                            ...
                                                            <div class="flex-2 mr-3">
                                                                ...
                                                                <a href="{{ route('back.slider.edit', $slider->id)}}">
                                                        ...
                                                        <form id="form_submit" class="hidden" action="{{ route('back.slider.delete')}}" method="POST">
                                                            @csrf
