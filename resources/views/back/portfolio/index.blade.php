                                        ...
                                        <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                                            ...
                                            <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                                ...
                                                <tr class="even:bg-slate-50 dark:even:bg-slate-700">
                                                    ...
                                                    <td class="table-td">{{ $portfolio->title }}</td>
                                                    <td class="table-td">{{ $portfolio->slug }}</td>
                                                    <td class="table-td">
                                                        <img class=" w-20" src="{{ asset($portfolio->image) }}" alt="image">
                                                    </td>
                                                    <td class="table-td">{{ $portfolio->subtitle }}</td>
                                                    <td class="table-td">{{ $portfolio->Category->name }}</td>
                                                    <td class="table-td">{{ $portfolio->created_at->format("d M Y") }}</td>
                                                        ...
                                                        <td class="table-td">
                                                            ...
                                                            <div class="flex-2 mr-3">
                                                                ...
                                                                <a href="{{ route('back.portfolio.edit', $portfolio->slug)}}">
                                                        ...
                                                        <form id="form_submit" class="hidden" action="{{ route('back.portfolio.delete')}}" method="POST">
                                                            @csrf
