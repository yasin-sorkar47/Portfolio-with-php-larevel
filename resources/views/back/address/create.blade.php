          ...
          <div class="grid xl:grid-cols-1 grid-cols-1 gap-6">
            ...
            <div class="card">
              <div class="card-body flex flex-col p-6">
                ...
                <form action="{{ route('back.address.store')}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                    <div class="flex-1">
                      <div class="card-title text-slate-900 dark:text-white ">Create Address</div>
                    </div>
                  </header>
                  <div class="card-text h-full space-y-4">
                    <div class="input-area">
                      <label for="phone" class="form-label">Phone</label>
                      <input id="phone" value="{{ old('phone') ? old('phone') : ''}}" name="phone" type="text" class="form-control" placeholder="Phone Number">
                    ...
                    <div class="input-area">
                      ...
                      <input id="address" value="{{ old('address') ? old('address') : ''}}" name="address" type="text" class="form-control" placeholder="Address">
