          ...
          <div class="grid xl:grid-cols-1 grid-cols-1 gap-6">
            ...
            <div class="card">
              <div class="card-body flex flex-col p-6">
                ...
                <form action="{{ route('back.technology.store')}}" method="POST" enctype="multipart/form-data">
                  @csrf

                  <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                    <div class="flex-1">
                      <div class="card-title text-slate-900 dark:text-white ">Create Technology</div>
                    </div>
                  </header>
                  <div class="card-text h-full space-y-4">
                    <div class="input-area">
                      <label for="title" class="form-label">Technologly Title</label>
                      <input id="title" value="{{old('title') ? old('title') : ""}}" name="title" type="text" class="form-control" placeholder="Technologly Title">
