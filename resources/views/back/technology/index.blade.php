                ...
                <div class="grid xl:grid-cols-1 grid-cols-1 gap-6">
                    <div class="card">
                        <header class="card-header noborder">
                            <h4 class="card-title">All Technology </h4>
                        </header>
                                        ...
                                        <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                                            ...
                                            <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                                ...
                                                <tr class="even:bg-slate-50 dark:even:bg-slate-700">
                                                    ...
                                                    <td class="table-td">{{ $technology->title }}</td>
                                                    <td class="table-td">
                                                        <img class=" w-20" src="{{ asset($technology->image) }}" alt="image">
                                                    </td>
                                                    <td class="table-td">{{ $technology->created_at->format("d M Y") }}</td>
                                                    <td class="table-td">
                                                        <div class=" flex">
                                                            <div class="flex-2 mr-3">
                                                                <div text="primary" class="btn btn-primary w-8 flex justify-center align-content-center">
                                                                    <a href="{{ route('back.technology.edit', $technology->id)}}">
                                                        ...
                                                        <form id="form_submit" class="hidden" action="{{ route('back.technology.delete')}}" method="POST">
                                                            @csrf
                                                            <input type="text" name="id" value="{{ $technology->id }}">
                                                        </form>
                                                    </td>
                                                </tr>       
                                                @empty
