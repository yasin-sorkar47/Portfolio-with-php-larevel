          ...
          <div class="grid xl:grid-cols-1 grid-cols-1 gap-6">
            ...
            <div class="card">
              <div class="card-body flex flex-col p-6">
                ...
                <form action="{{ route('back.category.store')}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="card-text h-full space-y-4">
                    <div class="input-area">
                      ...
                      <input id="name" value="{{old('name') ? old('name') : ""}}" name="name" type="text" class="form-control" placeholder="Category Name">
